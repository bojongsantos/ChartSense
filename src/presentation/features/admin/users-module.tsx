...
interface AdminUser { id: string; name: string; email: string; role: "USER" | "ADMIN"; plan: "FREE" | "PREMIUM"; emailVerified: boolean; createdAt: string; _count: { watchlist: number; sessions: number; payments: number } }
